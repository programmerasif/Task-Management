        ...
        <div className="bg-[#00000042]  rounded-md text-center h-full w-96 text-white">
...

            {
                ...
                <div className="text-sm font-bold mt-3 text-black flex justify-between items-center gap-2">
                    <button className="bg-white px-7 py-2 rounded-full" onClick={() => handelDoing(item._id)}>Doing</button>
                    <button className="bg-white px-7 py-2 rounded-full">Done</button>
                    <button className="bg-white px-7 py-2 rounded-full text-xl hover:bg-red-600 hover:text-white duration-300" onClick={() => handelDelet(item._id)} > <FaBan/> </button>
                </div>
            </div>
                    </>)
                }
